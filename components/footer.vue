<template>
  <footer class="footer-main relative z-10 dark:bg-dark pt-20 pb-10 lg:pb-20">
    <div class="container mx-auto">
      <div class="text-container flex flex-wrap -mx-4">
        <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div class="w-full mb-10">
            <h4
              class="uppercase text-lg font-semibold text-dark dark:text-white mb-9"
            >
              Helpful links
            </h4>
            <ul class="space-y-3">
